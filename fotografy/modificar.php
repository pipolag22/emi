...
<html lang="en">
    ...
    <body>
        ...
        <form action="" method="post" enctype="multipart/form-data">
            <label>Nombrea</label>
            <input type="text" name="nombre" placeholder="Nombre" value="<?php echo "$text"; ?>">
            <label>Posicion</label>
            <input type="text" name="posicion" placeholder="Posicion" value="<?php echo "$dimension"; ?>">
            <label>Imagen</label>
        ...
        if(array_key_exists('guardar_cambios',$_POST)){
            ...
            // a) generar la consulta a realizar
             $consulta = "UPDATE imagenes SET text='$text', dimension='$dimension', formato='$formato', imagen='$imagen' WHERE id=$id";
