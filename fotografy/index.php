...
-->
  ...
  <body>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link nav-link-3" href="login.html">Login</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class=" row mb-4 container-fluid tm-container-content tm-mt-60">
    <?php
                  // 1) Conexion
      ...
      <div class="row mb-4">
        <h2 class="col-6 tm-text-primary">Latest Memes</h2>
      </div>
      <div class="row tm-mb-90 tm-gallery">
        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
          ...
          <div class="d-flex justify-content-between tm-text-gray">
            <span class="tm-text-gray-light">7 dic 2022</span>
      ...
      <div class="container-fluid tm-container-small">
        ...
        <div class="row">
          <div class="col-lg-8 col-md-7 col-12 px-5 mb-3">
            Copyright 2020 MEMETROY Company. All rights reserved.
          </div>
